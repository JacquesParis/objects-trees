...
export class ObjectNodeDefinitionService implements EntityDefinitionInterface {
  ...
  public async getObjectNodeDefinition(
    ...
    if (forCreation && schema.properties.name) {
      schema.properties.name.description =
        'The name is used to identified the object. By default it will be generated by transformation from the displayed name keeping allowed characters (alphanumeric, -, _ or .).';
    }
